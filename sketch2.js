/* I organized and removed some stuff in the files so it looks less cluttered. I moved all the pen images into a folder and made sure it worked on the website.

Going to work more on the background color picker tomorrow. 
The issue is that the background is overlapping with the pen colors / surprise pens so it isn't drawing anything on the canvas for both drawing modes. - Margaret */
